...
//void nrf_cal_set_callback(void (*callback)(void), uint32_t interval);			// original
//void nrf_cal_set_callback(void (*callback)(void),void (*callback_CC1)(void),uint32_t interval);		// david edit
//void nrf_cal_set_callback(void (*callback)(void),void (*callback_CC1)(void),void (*callback_CC2)(void),uint32_t interval);		// david edit
